...
class AboutTraversables extends KoanSuite with ShouldMatchers {
  ...
  koan( """You would choose foldLeft/reduceLeft or foldRight/reduceRight based on your mathematical goal.
    ...
    val reduceLeftStartTime = System.nanoTime 
    (1 to MAX_SIZE) reduceLeft (_ + _)
    val reduceLeftEndTime = System.nanoTime


    val reduceRightStartTime = System.nanoTime
    (1 to MAX_SIZE) reduceRight (_ + _)
    val reduceRightEndTime = System.nanoTime

    val totalReduceLeftTime = reduceLeftEndTime - reduceLeftStartTime
    val totalReduceRightTime = reduceRightEndTime - reduceRightStartTime
